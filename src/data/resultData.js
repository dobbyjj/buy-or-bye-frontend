export const mbtiResultData = {
  ENFJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ENFJ.png',
    E_score: 70,
    N_score: 75,
    F_score: 80,
    P_score: 30,
  ...
  ENFP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ENFP.png',
    E_score: 80,
    N_score: 85,
    F_score: 90,
    P_score: 80,
  ...
  ENTJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ENTJ.png',
    E_score: 75,
    N_score: 80,
    F_score: 20,
    P_score: 25,
  ...
  ENTP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ENTP.png',
    E_score: 60,
    N_score: 90,
    F_score: 30,
    P_score: 70,
  ...
  ESFJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ESFJ.png',
    E_score: 80,
    N_score: 30,
    F_score: 75,
    P_score: 20,
  ...
  ESFP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ESFP.png',
    E_score: 90,
    N_score: 25,
    F_score: 85,
    P_score: 90,
  ...
  ESTJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ESTJ.png',
    E_score: 65,
    N_score: 15,
    F_score: 15,
    P_score: 10,
  ...
  ESTP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ESTP.png',
    E_score: 75,
    N_score: 20,
    F_score: 25,
    P_score: 75,
  ...
  INFJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/INFJ.png',
    E_score: 30,
    N_score: 80,
    F_score: 80,
    P_score: 35,
  ...
  INFP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/INFP.png',
    E_score: 20,
    N_score: 95,
    F_score: 95,
    P_score: 85,
  ...
  INTJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/INTJ.png',
    E_score: 25,
    N_score: 75,
    F_score: 10,
    P_score: 15,
  ...
  INTP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/INTP.png',
    E_score: 35,
    N_score: 85,
    F_score: 20,
    P_score: 65,
  ...
  ISFJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ISFJ.png',
    E_score: 20,
    N_score: 20,
    F_score: 70,
    P_score: 15,
  ...
  ISFP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ISFP.png',
    E_score: 15,
    N_score: 35,
    F_score: 90,
    P_score: 80,
  ...
  ISTJ: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ISTJ.png',
    E_score: 10,
    N_score: 5, 
    F_score: 5, 
    P_score: 5, 
  ...
  ISTP: {
    ...
    image: 'https://github.com/SeSAC-FlexAI/buy-or-bye/raw/main/img/ISTP.png',
    E_score: 25,
    N_score: 10,
    F_score: 10,
    P_score: 60,
